...
public class DeviceSettings extends Activity {
    ...
    public static final String SHARED_PREFERENCES_BASENAME = "com.legacyxperiaaosp.settings.device";
    public static final String ACTION_UPDATE_PREFERENCES = "com.legacyxperiaaosp.settings.device.UPDATE";
