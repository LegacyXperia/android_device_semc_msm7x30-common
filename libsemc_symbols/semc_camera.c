...
extern int _ZN7android19GraphicBufferMapper4lockEPK13native_handlejRKNS_4RectEPPv(
        buffer_handle_t handle, uint32_t usage, const Rect& bounds, void** vaddr);
extern int _ZN7android19GraphicBufferMapper4lockEPK13native_handleiRKNS_4RectEPPv(
