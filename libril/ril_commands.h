...
*/
    ...
    {RIL_REQUEST_VOICE_REGISTRATION_STATE, dispatchVoid, responseRegState},
    ...
    {RIL_REQUEST_QUERY_FACILITY_LOCK, dispatchQueryFacility, responseInts},
    {RIL_REQUEST_SET_FACILITY_LOCK, dispatchSetFacility, responseInts},
    ...
    {RIL_REQUEST_QUERY_AVAILABLE_NETWORKS , dispatchVoid, responseAvailableNetworks},
    ...
    {RIL_REQUEST_CDMA_GET_SUBSCRIPTION_SOURCE_V3, dispatchCdmaSubscriptionSource, responseInts},
    {0, dispatchVoid, responseVoid},
    {0, dispatchVoid, responseVoid},
    {0, dispatchVoid, responseVoid},
    {RIL_REQUEST_VOICE_RADIO_TECH_V3, dispatchVoiceRadioTech, responseInts},
    {0, dispatchVoid, responseVoid},
    {0, dispatchVoid, responseVoid},
    {0, dispatchVoid, responseVoid},
    {0, dispatchVoid, responseInts},
    {RIL_REQUEST_IMS_SEND_SMS_V3, dispatchImsSms, responseSMS},
